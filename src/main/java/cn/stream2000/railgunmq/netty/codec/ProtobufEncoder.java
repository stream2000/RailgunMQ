 ...
 */
@Sharable public class ProtobufEncoder extends MessageToByteEncoder<MessageLite> {
    ...
    @Override protected void encode(ChannelHandlerContext ctx, MessageLite msg, ByteBuf out) throws Exception {
